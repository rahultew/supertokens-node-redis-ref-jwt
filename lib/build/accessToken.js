        ...
        this.maybeGenerateNewKeyAndUpdateInDb = () =>
            __awaiter(this, void 0, void 0, function*() {
                while (true) {
                    ...
                    const mongoDriver = mongoNew_1.MongoDriver.getDriver();
                    let keyFromDB = yield mongoDriver.getKeyValueFromKeyName(ACCESS_TOKEN_SIGNING_KEY_NAME_IN_DB);
                    ...
                    if (keyFromDB === undefined || generateNewKey) {
                        ...
                        if (lastUpdatedSign === undefined) {
                            // no row exists in db
                            success = yield mongoDriver.insertKeyValueForKeyName(
                            ...
                            success =
                                (yield mongoDriver.updateKeyValueForKeyName(
                                    ACCESS_TOKEN_SIGNING_KEY_NAME_IN_DB,
                                    key.keyValue,
                                    key.createdAtTime,
                                    lastUpdatedSign

...
import { resetTables } from "./dbQueriesOld";
import { MongoDriver } from "./mongoNew";
 ...
 */
export async function reset(newConfig?: TypeInputConfig, mongoClient?: MongoClient | Connection) {
    ...
    try {
        ...
        if (newConfig !== undefined) {
            await init(newConfig, mongoClient);
        }
    }
}
